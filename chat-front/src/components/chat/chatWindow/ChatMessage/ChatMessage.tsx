...
interface IChatMessageProps {
  ...
  scrollToMessage: (replyToMessage: IMessage) => void
}
  ...
  return (
    ...
    >
      ...
      >
        {(isMessageReplied) && (
          <div 
          className={`${styles.replyMessage} ${styles.backgroundColor}`}
          onClick={() => scrollToMessage(message)}
          >
            <p className={styles.author}>{replyFirstName + ' ' + replyLastName}</p>
            <p className={styles.replyMessageText}>{replyMessageText}</p>
          </div>
        )}
        {message.message}
      </div>
